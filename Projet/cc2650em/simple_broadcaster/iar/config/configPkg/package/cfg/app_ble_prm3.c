 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = E:/BeelinkerCode/simple_broadcaster_observer/Projet/cc2650em/simple_broadcaster/iar/config/configPkg/package/cfg/app_ble_prm3");
