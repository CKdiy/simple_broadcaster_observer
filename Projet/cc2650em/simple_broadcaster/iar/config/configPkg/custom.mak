...
linker.cmd: package/cfg/app_ble_prm3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_prm3cfg.cmd\)\"$""\"E:/BeelinkerCode/simple_broadcaster_observer/Projet/cc2650em/simple_broadcaster/iar/config/configPkg/\1\""' package/cfg/app_ble_prm3.xdl > $@
